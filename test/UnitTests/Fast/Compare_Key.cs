...
namespace UnitTests.Fast
{
    public class Compare_KeyUnitTests
    {
        ...
        public void OrderBySortsByKey()
        {
            ...
            list.Sort(FastComparerBuilder.For<Person>().CompareBy(p => p.FirstName));
...
#endif
            list.Sort(FastComparerBuilder.For<Person>().CompareBy(p => p.FirstName, invariantCultureComparer.Reverse()));
        ...
        {
            var list = new List<Person> { AbeAbrams, JackAbrams, WilliamAbrams, CaseyJohnson };
            list.Sort(FastComparerBuilder.For<Person>().CompareBy(p => p.FirstName, descending: true));
            Assert.Equal(new[] { WilliamAbrams, JackAbrams, CaseyJohnson, AbeAbrams }, list);
        }
        ...
        public void OrderByDescendingUsesKeyComparer()
        {
            ...
            StringComparer invariantCultureComparer = StringComparer.InvariantCulture;
#endif
            list.Sort(FastComparerBuilder.For<Person>().CompareBy(p => p.FirstName, invariantCultureComparer.MakeReverse<string, StringComparer>(), descending: true));
            Assert.Equal(new[] { AbeAbrams, CaseyJohnson, JackAbrams, WilliamAbrams }, list);
        }
        ...
        public void ThenBySortsByKey()
        {
            ...
            list.Sort(FastComparerBuilder.For<Person>().CompareBy(p => p.LastName).CompareBy(p => p.FirstName));
        ...
        public void ThenByUsesKeyComparer()
        {
            ...
            StringComparer invariantCultureComparer = StringComparer.InvariantCulture;
#endif
            list.Sort(FastComparerBuilder.For<Person>().CompareBy(p => p.LastName).ThenBy(p => p.FirstName, invariantCultureComparer.MakeReverse<string,StringComparer>()));
        ...
        {
            var list = new List<Person> { AbeAbrams, WilliamAbrams, CaseyJohnson, JackAbrams };
            list.Sort(FastComparerBuilder.For<Person>().CompareBy(p => p.LastName).CompareBy(p => p.FirstName, descending: true));
            Assert.Equal(new[] { WilliamAbrams, JackAbrams, AbeAbrams, CaseyJohnson }, list);
        }
        ...
        public void ThenByDescendingUsesKeyComparer()
        {
            ...
            StringComparer invariantCultureComparer = StringComparer.InvariantCulture;
#endif
            list.Sort(FastComparerBuilder.For<Person>().CompareBy(p => p.LastName).ThenBy(p => p.FirstName, invariantCultureComparer.Reverse(), descending: true));
            Assert.Equal(new[] { AbeAbrams, JackAbrams, WilliamAbrams, CaseyJohnson }, list);
        }
        ...
        public void OrderByWithNullPassesNullThrough()
        {
            ...
            list.Sort(FastComparerBuilder.For<Person>().CompareBy(p => p == null, specialNullHandling: true));
        ...
        public void OrderByWithNullThenByHandlesNull()
        {
            ...
            list.Sort(FastComparerBuilder.For<Person>().CompareBy(p => p == null, specialNullHandling: true).CompareBy(p => p.FirstName));
        ...
        {
            var comparer = FastComparerBuilder.For<Person>().CompareBy(p => p == null, specialNullHandling: true).CompareBy(p => p.FirstName).CompareBy(p =>
            {
        ...
        {
            var comparer = FastComparerBuilder.For<Person>().CompareBy(p => p.LastName);
        ...
        {
            var list = new List<Person> { AbeAbrams, JackAbrams, WilliamAbrams, CaseyJohnson };
            var comparer = FastComparerBuilder.For<Person>().CompareBy(p => p.FirstName.SelectMany(x => new[] { x }));
            list.Sort(comparer);
            Assert.Equal(new[] { AbeAbrams, CaseyJohnson, JackAbrams, WilliamAbrams }, list);
        }
