...
namespace Nito.Comparers.Fast
{
    ...
    public struct FastComparerBuilder<T>
    {
        /// <summary>
        ...
        public IFullComparer<T> CompareBy<TKey, TComparer>(Func<T, TKey> selector, TComparer keyComparer, bool specialNullHandling = false, bool descending = false)where TComparer:IComparer<TKey>,IEqualityComparer<TKey>
        {
            return (Null()).CompareBy(selector, keyComparer, specialNullHandling, descending);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public IFullComparer<T> CompareBy<TKey>(Func<T, TKey> selector, IFullComparer<TKey> keyComparer, bool specialNullHandling = false, bool descending = false)
        {
            return (Null()).CompareBy<T,TKey, IFullComparer<TKey>,IFullComparer<T>>(selector, keyComparer, specialNullHandling, descending);
        }
        /// <summary>
        /// Creates a key comparer.
        /// </summary>
        ...
        /// <param name="descending">A value indicating whether the sorting is done in descending order. If <c>false</c> (the default), then the sort is in ascending order.</param>
        /// <returns>A key comparer.</returns>
        public IFullComparer<T> CompareBy<TKey>(Func<T, TKey> selector, bool specialNullHandling = false, bool descending = false)
        {
            return (Null()).CompareBy(selector, ComparerBuilder.For<TKey>().Default(), specialNullHandling, descending);
        }
    }
    ...
    /// </summary>
    public static class FastComparerBuilder
    {
        /// <summary>
        /// Creates a source for a comparer of type <typeparamref name="T"/>.
        /// </summary>
        /// <typeparam name="T">The type of objects being compared.</typeparam>
        public static FastComparerBuilder<T> For<T>()
        {
            return new FastComparerBuilder<T>();
        }
        ...
        public static FastComparerBuilder<T> For<T>(Func<T> expression)
        {
            return new FastComparerBuilder<T>();
        }
        ...
        public static FastComparerBuilder<T> ForElementsOf<T>(Func<IEnumerable<T>> expression)
        {
            return new FastComparerBuilder<T>();
        }
        ...
        public static FastComparerBuilder<T> ForElementsOf<T>(IEnumerable<T> sequence)
        {
            return new FastComparerBuilder<T>();
        }
    }
...
namespace Nito.Comparers
{
    ...
    public struct ComparerBuilder<T>
    {
        ...
        {
            return ((IComparer<T>)Null()).ThenBy(selector, keyComparer, specialNullHandling, descending);
        }
    }
